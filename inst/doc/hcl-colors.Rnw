...
\Address{
  ...
  Augasse 2--6\\
  A-1090 Wien, Austria\\
  E-mail: \email{Achim.Zeileis@R-project.org}, \email{Kurt.Hornik@R-project.org}\\
  URL: \url{http://statmath.wu-wien.ac.at/~zeileis/},\\
  \phantom{URL:} \url{http://statmath.wu-wien.ac.at/~hornik/}
...
This is a companion vignette to \cite{color:Zeileis+Hornik:2006} 
and \cite{color:Zeileis+Hornik+Murrell:2007} providing
