...
scale_colour_continuous_qualitative <- function(palette = NULL, c1 = NULL, l1 = NULL, h1 = NULL, h2 = NULL,
                                                alpha = 1, rev = FALSE, begin = 0, end = 1, na.value = "grey50",
...
#'
#' Binned ggplot2 color scales using the color palettes generated by \code{\link{qualitative_hcl}}. These scales are provided
...
#' @importFrom stats na.omit
#' @export
scale_colour_binned_qualitative <- function(palette = NULL, c1 = NULL, l1 = NULL, h1 = NULL, h2 = NULL,
                                            alpha = 1, rev = FALSE, begin = 0, end = 1, na.value = "grey50",
                                            guide = "coloursteps", aesthetics = "colour", n_interp = 11, ...)
{
  # arguments we want to hand off to function qualitative_hcl only if explicitly provided
  hcl_args <- c("palette", "c1", "l1", "h1", "h2")
...
#' @rdname scale_colour_binned_qualitative
#' @export
scale_color_binned_qualitative <- scale_colour_binned_qualitative

#' @rdname scale_colour_binned_qualitative
#' @export
scale_fill_binned_qualitative <- function(..., aesthetics = "fill")
{
  args <- as.list(match.call())
  args[[1]] <- NULL # remove the function call
  if (is.null(args[["aesthetics"]])) args$aesthetics <- "fill"
